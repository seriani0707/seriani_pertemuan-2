 ...
 */
let users = [
  {name: "Seri Ani Ritonga", age: 21, major: "informatika"},
  {name: "Sayrul yahya", age: 15, major: "agama"},
  {name: "Aris", age: 17, major: "Bisnis Digital"},
  {name: "Mulai", age: 24, major: "Sistem Informasi"},
  {name: "Muharram", age: 22, major: "Hukum"},
];
